...
public final class CountriesData {
    ...
    public static final Position antartica = new Position(-66.652935, 53.021466,
            "Antartica", "Antartica", "Antartica", 5);
    ...
    public static HashMap<String, Position> localizationsInAntartica = null;
