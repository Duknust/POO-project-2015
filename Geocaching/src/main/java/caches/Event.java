...
public class Event extends Cache {
    ...
    // Constructors
    public Event(HashMap<String, UserAbstract> participants, GregorianCalendar date, int maxParticipants, GregorianCalendar publishDate, GregorianCalendar creationDate, String cacheID, boolean premiumOnly, String description, Status cacheState, String cacheTitle, UserAbstract owner, int cacheSize, float difficulty, Position position, String hint, TreeSet<Log> cache_Logs, Reviewer reviewer) {
    ...
    public Event(GregorianCalendar creationDate, String description, String cacheTitle, int cacheSize, float difficulty, Position position, String hint, TreeSet<Log> cache_Logs, HashMap<String, UserAbstract> participants, GregorianCalendar date, int maxParticipants) {
